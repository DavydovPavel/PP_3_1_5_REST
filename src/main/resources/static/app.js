        ...
        let bodyForm = `<form id="deleteUser">
                            <div class="col-md-7 offset-md-3 text-center">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="${user.lastname}" name="firstname" class="form-control" readonly>
                                </div>
                                <div class="form-group">
    ...
    user.then(user => {
        let bodyForm = `<form id="editUser">
                            <div class="col-md-7 offset-md-3 text-center">
                                ...
                                <div class="form-group">
                                    <span class="font-weight-bold">Last name</span>
                                    <input type="text" value="${user.lastNname}" name="firstname" id="firstname" class="form-control">
                                </div>
                                <div class="form-group">
                                    <span class="font-weight-bold">Email</span>
